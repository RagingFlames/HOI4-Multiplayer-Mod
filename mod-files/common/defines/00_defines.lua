...
NGame = {
	...
	LAG_DAYS_FOR_LOWER_SPEED = 36,					-- Days of client lag for decrease of gamespeed
	LAG_DAYS_FOR_PAUSE = 60,						-- Days of client lag for pause of gamespeed.
	GAME_SPEED_SECONDS = { 1.0, 0.5, 0.2, 0.1, 0.07 }, -- game speeds for each level. Must be 5 entries with last one 0 for unbound
